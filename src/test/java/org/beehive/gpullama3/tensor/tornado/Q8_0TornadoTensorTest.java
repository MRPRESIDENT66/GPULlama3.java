...
public class Q8_0TornadoTensorTest {
    ...
    @Test
    public void repacksScalesAndQuantsIntoAlignedStreams() {
        ...
        assertEquals(192, repacked.getSize());
        assertEquals(0.5f, repacked.getHalfFloat(0).getFloat32(), 0.0f);
        assertEquals(0.25f, repacked.getHalfFloat(2).getFloat32(), 0.0f);
        for (int i = 0; i < 32; i++) {
            assertEquals((byte) (i - 16), repacked.get(128 + i));
            assertEquals((byte) (31 - i), repacked.get(160 + i));
        }
